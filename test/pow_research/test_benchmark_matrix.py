...
"""Unit tests for the C++ benchmark matrix orchestration."""
...
class BenchmarkMatrixTest(unittest.TestCase):
    def test_smoke_profile_is_bounded(self) -> None:
        ...
        self.assertTrue(all(config.dataset_bytes <= 256 * 1024 for config in configs))
    ...
    def test_seed_derivation_is_reproducible_and_separated(self) -> None:
