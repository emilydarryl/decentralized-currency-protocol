...
install -m 0755 "${SOURCE_DIR}/contrib/mining_autonomy/build_resilience_evidence.py" "${kit_root}/libexec/build_resilience_evidence.py"
install -m 0755 "${SOURCE_DIR}/contrib/mining_autonomy/share_replica_client.py" "${kit_root}/libexec/share_replica_client.py"
install -m 0755 "${SOURCE_DIR}/contrib/mining_autonomy/build_share_settlement_evidence.py" "${kit_root}/libexec/build_share_settlement_evidence.py"
