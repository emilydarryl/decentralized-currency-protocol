...
"""Collect frozen hierarchical checkpoint-ladder evidence for PoW v1."""
...
FORMAT = "soveroot-pow-v1-hierarchical-checkpoint-ladder-matrix-v0"
...
def build_matrix(
    ...
    return {
        "format": FORMAT,
        "warning": "NON-CONSENSUS HIERARCHICAL CHECKPOINT-LADDER SCREEN; no gate assessment",
...
def main() -> int:
    ...
    try:
        document = build_matrix(args.profile, args.seeds, args.operation_limit)
