...
"""Collect paged-gap reconstruction evidence for PoW v1."""
...
FORMAT = "soveroot-pow-v1-paged-gap-reconstruction-matrix-v0"
...
def build_matrix(profile_name: str, seeds: int | None = None, source_revision: str = "unrecorded") -> dict[str, object]:
    ...
    return {
        "format": FORMAT,
        "warning": "NON-CONSENSUS PAGED-GAP PILOT; no completed proof, throughput, or gate assessment",
        ...
        "all_runs_exhausted_without_digest": all(
            case["status"] == "refused_paged_gap_exhausted" and case["execution_result"] is None
            for case in cases
        ),
        "memory_scope": {
