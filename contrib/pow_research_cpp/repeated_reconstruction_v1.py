...
"""Collect repeated bounded reconstruction evidence for PoW v1."""
...
FORMAT = "soveroot-pow-v1-bounded-repeated-reconstruction-matrix-v0"
...
def build_matrix(
    ...
    return {
        "format": FORMAT,
        "warning": "NON-CONSENSUS REPEATED RECONSTRUCTION; no completed proof, throughput, or PoW gate assessment",
        ...
        "all_runs_reconstructed_repeatedly": all(
            ...
            and case["all_replay_states_matched"]
            for case in cases
        ),
        "all_runs_exhausted_without_digest": all(
            case["status"] == "refused_replay_workspace_exhausted"
