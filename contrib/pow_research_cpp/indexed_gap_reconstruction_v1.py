...
"""Collect indexed-gap reconstruction evidence for PoW v1."""
...
from contrib.pow_research_v1.indexed_gap_reconstruction import reconstruct_with_indexed_gaps
from contrib.pow_research_v1.powvm import prepare_epoch


FORMAT = "soveroot-pow-v1-indexed-gap-reconstruction-matrix-v0"
...
def build_matrix(profile_name: str, seeds: int | None = None, source_revision: str = "unrecorded") -> dict[str, object]:
    ...
    return {
        "format": FORMAT,
        "warning": "NON-CONSENSUS INDEXED-GAP PILOT; no completed proof, throughput, or gate assessment",
        ...
        "all_runs_exhausted_without_digest": all(
            case["status"] == "refused_indexed_gap_exhausted" and case["execution_result"] is None
            for case in cases
        ),
        "memory_scope": {
